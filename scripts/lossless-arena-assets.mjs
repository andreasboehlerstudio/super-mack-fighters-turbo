...
const source=path.join(root,'public/assets/arenas'),archive=path.join(root,'art-source/arenas');
...
if(records.length){await writeFile(path.join(root,'docs/art/lossless-arenas.json'),JSON.stringify(records,null,2)+'\n');}
