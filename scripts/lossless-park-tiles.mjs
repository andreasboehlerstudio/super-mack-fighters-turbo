...
const source=path.join(root,'public/assets/atlas/detail'),archive=path.join(root,'art-source/atlas/detail');
...
if(records.length){await writeFile(path.join(root,'docs/art/lossless-atlas-tiles.json'),JSON.stringify(records,null,2)+'\n');}
