...
let md='# Pixelraster-Abgleich\n\n40 Figuren inklusive Endgegner; alle 17 Spielclips pro Figur geprüft. Prozentwerte messen exakt identische Farbblöcke im günstigsten Rasterversatz, nicht die künstlerische Qualität. Ein hoher Wert kann auch durch große einfarbige Flächen entstehen.\n\n| Figur | Portrait (4×4) | Stand (2×2) | Lauf (2×2) | Tritt (2×2) |\n|---|---:|---:|---:|---:|\n';
