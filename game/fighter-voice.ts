...
export const FIGHTER_VOICES:Record<FighterId,Voice>={
 ...
 jan:human(132,.26),vendel:human(148,.18),valentina:human(236,.09),
 kuebler:human(166,.08),sebastien:human(140,.18),schaer:human(228,.1),glen:human(130,.18),steffen:human(158,.15),
