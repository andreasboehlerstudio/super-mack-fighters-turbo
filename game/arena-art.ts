...
export const ARENA_ART=Object.fromEntries([
 ...
 ['park-1',{url:'/assets/arenas/park-1-golden-hour-v3.webp',source:ARENA_PHOTOS['park-1'].source,alt:'Deutschland: heller Vorplatz im goldenen Abendlicht mit tief stehender Sonne'}],
