...
test('new fighters execute all three specials and retain projectile identity after a tag',()=>{
 for(const id of ['vendel','karsten','edda','scholz','bobo','mross','otto','ross','freudenreich','robbemond','olli','boeckli','louis','tesla'] as FighterId[])for(let move=0;move<3;move++){
